...
accelerate launch --config-file ./default_config.yaml --main_process_port 29502 train.py --batch_size 8 --run_name gan_TEST --model unet_dm_gan --logger tensorboard --save_every_epochs 5 --val_every_epochs 2
